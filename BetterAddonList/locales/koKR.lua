...
L["Addon List"] = "애드온 목록"
L["Create new set"] = "새 세트 생성"
L["Delete"] = "삭제"
L["Delete set %s?"] = "%s 세트를 삭제할까요?"
L["Disable addons from this set"] = "이 세트의 애드온 사용 안 함"
L["Disable all addons then enable addons in this set."] = "모든 애드온을 비활성화하고 이 세트의 애드온을 사용합니다."
L["Disabled addons in set %q."] = "%q 세트의 애드온을 사용하지 않습니다."
L["Disabled all addons."] = "모든 애드온을 사용하지 않습니다."
L["Enable addons from this set"] = "이 세트의 애드온 사용"
L["Enabled addons in set %q."] = "%q 세트의 애드온을 사용합니다."
L["Enabled only addons in set %q."] = "%q 세트의 애드온만 사용합니다."
...
L["Out of date addons are being disabled! They will not be able to load until their interface version is updated or \"Load out of date AddOns\" is checked."] = "구버전 애드온은 사용할 수 없습니다! 인터페이스 버전이 업데이트되거나 \"구버전 불러오기\"를 선택하기 전까지는 불러올 수 없습니다."
