...
L["Restore On Exit"] = "\nSuas configurações anteriores serão restauradas após sair.";

L["Photo Mode"] = "Modo Foto";
L["Photo Mode Tooltip Open"] = "Abre a dica de HUD de captura de tela.";
L["Photo Mode Tooltip Close"] = "Fecha a dica de HUD de captura de tela.";
L["Photo Mode Tooltip Special"] = "Suas capturas de tela na pasta WoW Screenshots não incluirão esta dica de HUD.";

L["Toolbar Mog Button"] = "Modo Foto";
L["Toolbar Mog Button Tooltip"] = "Exiba seu transmog ou crie uma cabine de fotos onde você pode adicionar outros jogadores e PNJs.";

L["Toolbar Emote Button"] = "Faça Expressões";
L["Toolbar Emote Button Tooltip"] = "Use expressões com animações exclusivas.";
...
L["Toolbar Preferences Button Tooltip"] = "Abra o painel de opções.";
...
L["AFK Screen Description"] = "Abrir o Narcissus automaticamente quando estiver ausente";
L["AFK Screen Description Extra"] = "Isso substituirá o modo ausente do ElvUI.";
L["AFK Screen Delay"] = "Após um atraso cancelável";
...
L["Dressing Room Description"] = "Mostra um Provador maior com a capacidade de visualizar e copiar itens de outros jogadores e gerar links para o provador do Wowhead.";
...
L["Fade Out Description"] = "Ocultar botão ao mover o cursor para fora";
L["Hotkey"] = "Tecla de atalho";
L["Double Tap"] = "Ativar clique duplo";
L["Double Tap Description"] = "Toque duas vezes na tecla vinculada ao quadro de Informações do Personagem para abrir o Narcissus.";
L["Show Detailed Stats"] = "Mostrar estatísticas detalhadas";
L["Tooltip Color"] = "Cor da dica de HUD";
...
L["Exit Confirmation Texts"] = "Sair da foto de grupo?";
...
L["Use Bust Shot"] = "Focar o Tronco";
L["Use Escape Button"] = "Tecla ESC";
L["Use Escape Button Description"] = "Você pode clicar no botão X oculto no canto superior direito da tela para sair.";
L["Show Module Panel Gesture"] = "Mostrar Módulo do Painel ao passar o mouse";
L["Independent Minimap Button"] = "Impedir modificações por outros AddOns";
...
L["Creature Tooltip"] = "Dica de HUD de criaturas";
L["RAM Usage"] = "Uso de RAM";
L["Others"] = "Outros";
L["Find Relatives"] = "Localizar relativos";
L["Find Related Creatures Description"] = "Procure por criaturas com o mesmo segundo nome.";
L["Find Relatives Hotkey Format"] = "Pressione %s para encontrar relativos.";
L["Translate Names"] = "Traduzir nomes";
L["Translate Names Description"] = "Mostrar nomes traduzidos na...";
...
L["Select Language Multiple"] = "Selecione os idiomas para mostrar na dica de HUD";
...
L["Tooltip"] = "Dica de HUD";
L["Name Plate"] = "Placa de identificação";
L["Offset Y"] = "Desl. Y (vertical)";
...
L["Orbit Camera Description On"] = "Quando você abrir este painel de personagem, a câmera irá girar para sua frente e começará a lhe orbitar.";
L["Orbit Camera Description Off"] = "Ao abrir este painel de personagem, a câmera será ampliada sem rotação";
L["Camera Safe Mode"] = "Modo Seguro da Câmera";
L["Camera Safe Mode Description"] = "Desativa completamente o recurso ActionCam após fechar este AddOn.";
...
L["Camera Transition Description On"] = "A câmera se moverá suavemente para a posição predeterminada quando você abrir este painel de personagem.";
L["Camera Transition Description Off"] = "O movimento da câmera se torna instantâneo. Começa a partir da segunda vez que você usa este painel de personagem.\nA transição instantânea substituirá a predefinição #4 da câmera.";
...
L["Conduit Tooltip"] = "Efeitos de Conduíte de classificações mais altas";
L["Paperdoll Widget"] = "Indicador de Conjunto de Classe";
L["Item Tooltip"] = "Dica de HUD de item";
L["Style"] = "Estilo";
...
L["Binding Name Open Narcissus"] = "Abra o painel de personagem Narcissus";
...
L["Light Types Tooltip"] = "Alterne entre\n- Luz direcional que pode ser bloqueada pelo objeto e projeta sombra\n- Luz ambiente que influencia todo o modelo";
...
L["Ground Shadow"] = "Sombra do solo";
L["Ground Shadow Tooltip"] = "Adicione uma sombra de solo móvel abaixo de seu modelo.";
...
L["Show Color Sliders"] = "Mostrar controles deslizantes de cores";
L["Show Color Presets"] = "Mostrar predefinições de cores";
...
L["Sex Change Tooltip"] = "Mudar de sexo";
...
L["Animation Tooltip"] = "Navegue, procure animações";
...
L["Toggle Browser"] = "Alternar navegador visual de feitiço";
...
L["Favorites Add"] = "Adicionar aos meus favoritos";
...
--Navegador de PNJ
NARCI_NPC_BROWSER_TITLE_LEVEL = ".ível %?%?.?";      --Nível ?? --Use isso para verificar se a segunda linha da caixa de texto é o título ou o tipo de unidade do PNJ
...
L["Corruption Bar Description"] = "Ative a barra de corrupção ao lado do painel de personagens.";
L["Corruption Debuff Tooltip"] = "Dica de HUD de penalidades";
L["Corruption Debuff Tooltip Description"] = "Substitua a dica de HUD de penalidades padrão por sua contraparte numérica.";
...
L["Use Achievement Panel Description"] = "Clique na conquista obtida ou conquistas rastreadas para abrir este painel.";
L["Incomplete First"] = "Incompletos primeiro";
L["Earned First"] = "Completados primeiro";
L["Settings"] = "Configurações";
L["Next Prev Card"] = "Próximo/Anterior";
L["Track"] = "Listar";   --Acompanhar conquistas
L["Show Unearned Mark"] = "Mostrar não aprendidos";
L["Show Unearned Mark Description"] = "Marque as conquistas que não foram conquistadas por mim com um X vermelho.";
...
L["Guide Spell Line1"] = "A maioria dos visuais de feitiços que você adiciona clicando no botão esquerdo desaparecerá em segundos, enquanto aqueles que você adiciona clicando no botão direito não.\n\nAgora, por favor, mova para uma entrada então:";
L["Guide Spell Choose Category"] = "Você pode adicionar visuais de feitiços ao seu modelo. Escolha qualquer categoria que você gosta. Em seguida, escolha uma subcategoria.";
...
L["Guide Minimap Button Headline"] = "Botão Minimapa";
...
--Navegador de armas
L["Draw Weapon"] = "Desenhar Arma";
L["Unequip Item"] = "Desequipar";
L["WeaponBrowser Guide Hotkey"] = "Especifique qual mão segura a arma:";
L["WeaponBrowser Guide ModelType"] = "Alguns itens são limitados a determinado tipo de modelo:";
L["WeaponBrowser Guide DressUpModel"] = "Este será o tipo padrão se seu alvo for um jogador, a menos que você esteja segurando <%s> ao criá-lo.";
L["WeaponBrowser Guide CinematicModel"] = "O tipo de modelo sempre será de Cinemática se a criatura for um PNJ. Você não pode embainhar armas.";
...
L["Missing Enchant Alert"] = "Alerta de itens não encantados";
...
L["Period Tooltip"] = "O tempo que leva para completar uma rotação.\nDeve ser também a |cffccccccduração do corte|r do seu GIF ou vídeo.";
L["MSAA Tooltip"] = "Modifique temporariamente o Anti-Aliasing para suavizar as bordas irregulares ao custo do desempenho.";
...
L["Outline Show"] = "Clique para mostrar o contorno";
L["Outline Hide"] = "Clique para ocultar o contorno";
L["Preset"] = "Predefinição";
L["File"] = "Arquivo";     --Nome do Arquivo
L["File Tooltip"] = "Coloque sua própria imagem em |cffccccccWorld of Warcraft\\retail\\Interface\\AddOns|r e insira o nome do arquivo nesta caixa.\nA imagem deve ser um arquivo |cffccccccJPG|r |cffcccccc512x512|r ou |cffcccccc1024x1024|r";
...
--Formato de combinação das dicas de HUD
...
L["Show Talent Tree Paperdoll"] = "Abrir o painel de Informações do Personagem";
...
L["Place Talent UI Right"] = "à direita do Quadro do Jogador/Inspeção";
L["Place Talent UI Bottom"] = "Abaixo do Quadro do Jogador/Inspeção";

--Filtro de itens de bolsa
...
L["Auto Filter Case"] = "Filtra itens automaticamente quando você...";
