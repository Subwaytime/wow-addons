...
L["DOCK_AND_EDITBOX"] = "Вкладки чата и поле ввода"
L["DOWNLOADS"] = "Загрузки"
L["EDITBOX_POSITION"] = "Положение поля ввода"
...
L["FADING"] = "Затухание"
L["FONT"] = "Шрифт"
L["FONT_EDITBOX"] = "Шрифт поля ввода"
L["MESSAGES"] = "Сообщения"
L["MOUSEOVER_TOOLTIPS"] = "Подсказки по наведению мыши"
L["OFFSET"] = "Смещение"
L["OPEN_CONFIG"] = "Настройки"
L["OUTLINE"] = "Контур"
L["PERSISTENT"] = "Устойчивое"
L["SHADOW"] = "Тень"
L["SIZE"] = "Размер"
L["SLIDE_IN_DURATION"] = "Продолжительность скольжения"
L["SUPPORT"] = "Поддержка"
L["TOP"] = "Сверху"
