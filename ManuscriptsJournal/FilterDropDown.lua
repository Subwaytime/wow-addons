-- Adapted from FrameXML\FilterDropdown.lua
local addonName, addon = ...
local LibDD = LibStub:GetLibrary("LibUIDropDownMenu-4.0")

addon.FilterComponent = EnumUtil.MakeEnum(
...
--[[
	...
	LibDD:UIDropDownMenu_Initialize(self, ExampleFilterDropDown_Initialize, "MENU");
...
function FilterDropDownSystem.AddRadioButton(text, setSelected, isSelected, level, hideMenuOnClick)
	...
	LibDD:UIDropDownMenu_AddButton(radioButtonInfo, level);
end
...
function FilterDropDownSystem.AddSpace(level)
	LibDD:UIDropDownMenu_AddSpace(level);
end
...
function FilterDropDownSystem.AddTitle(text, level)
	...
	LibDD:UIDropDownMenu_AddButton(headerInfo, level);
end
...
function FilterDropDownSystem.AddSubMenuButton(text, value, set, level)
	...
	LibDD:UIDropDownMenu_AddButton(subMenuInfo, level)
end
