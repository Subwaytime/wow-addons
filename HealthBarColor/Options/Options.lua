...
local options = {
    ...
    args = {
                ...
                Player = {
                    ...
                    args = {
                        ...
                        color = {
                            ...
                            get = "GetColor",
                            set = "SetColor",
                            hidden = function() if HealthBarColor.db.profile.Fonts.Player.selected == 2 then return false end return true end,
                            width = colorWidth,
                        },  
                    },
                },
                Target = {
                    ...
                    args = {
                        ...
                        color = {
                            ...
                            get = "GetColor",
                            set = "SetColor",
                            hidden = function() if HealthBarColor.db.profile.Fonts.Target.selected == 2 then return true end return false end,
                            width = colorWidth,
                        },  
                        reaction = {
                            order = 3,
                            ...
                            get = "GetStatus",
                            set = "SetStatus",
                            hidden = function() if HealthBarColor.db.profile.Fonts.Target.selected == 1 then return false end return true end,
                        },
                    },
                },
                Focus = {
                    ...
                    args = {
                        ...
                        color = {
                            ...
                            get = "GetColor",
                            set = "SetColor",
                            hidden = function() if HealthBarColor.db.profile.Fonts.Focus.selected == 2 then return true end return false end,
                            width = colorWidth,
                        },  
                        reaction = {
                            order = 3,
                            ...
                            get = "GetStatus",
                            set = "SetStatus",
                            hidden = function() if HealthBarColor.db.profile.Fonts.Focus.selected == 1 then return false end return true end,
                        },
                    },
                },
                Pet = {
                    ...
                    args = {
                        ...
                        color = {
                            ...
                            get = "GetColor",
                            set = "SetColor",
                            hidden = function() if HealthBarColor.db.profile.Fonts.Pet.selected == 2 then return false end return true end,
                            width = colorWidth,
                        },  
                    },
                },
        ...
        Modules = {
            ...
            type = "group",
            hidden  = function() return not (HealthBarColor.db.profile.Settings.Modules.Textures or HealthBarColor.db.profile.Settings.Modules.BackgroundTextures or HealthBarColor.db.profile.Settings.Modules.DebuffColor ) end,
            args = {
                Textures = {
                    order = 1,
                    name = "Textures",
